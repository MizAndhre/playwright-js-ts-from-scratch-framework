...
import dataSet from './data/placeOrderTestData.json';

test('should login and find the element with json data', async ({ page }) => {
	...
	// Assert email
	await expect(checkoutPage.emailLabel).toHaveText(dataSet.email);
